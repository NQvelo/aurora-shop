  ...
  return (
    <section className="py-16 md:py-24 px-6 lg:px-12">
      ...
      <div className="text-center mb-12 font-body">
        ...
        <h2 className="font-body text-2xl md:text-3xl font-normal">
          {t("home.bestsellers")}
        </h2>
      </div>
          ...
          <div key={product.id} className="group">
            <Link to={pathFor(`/product/${product.id}`)} className="block">
              <div className="relative aspect-[3/4] bg-muted overflow-hidden mb-4">
                ...
                <div className="absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-black/60 to-transparent translate-y-full group-hover:translate-y-0 transition-transform duration-300 font-body">
      ...
      {/* View All Link */}
      <div className="text-center mt-12 font-body">
        <Link to={pathFor("/bestsellers")} className="btn-luxury-outline">
          {t("home.viewAll")}
        </Link>
      </div>
    </section>
