  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const orderItems = cart.map((item) => ({
        ...
        size: item.size,
        price: item.product.onSale && item.product.salePrice 
    ...
    <Layout>
      <div className="min-h-screen py-16 md:py-24 px-6 lg:px-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="font-display text-3xl md:text-4xl tracking-wide mb-12 text-center">
            Checkout
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Checkout Form */}
            <div>
              <h2 className="text-[11px] uppercase tracking-[0.15em] mb-6 font-medium">
                Shipping Information
              </h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-[10px] uppercase tracking-wider mb-1">Full Name</label>
                  <input
                    type="text"
                    name="name"
                    required
                ...
                <div>
                  <label className="block text-[10px] uppercase tracking-wider mb-1">Email Address</label>
                  <input
                    type="email"
                    name="email"
                    required
                ...
                <div>
                  <label className="block text-[10px] uppercase tracking-wider mb-1">Mobile Number</label>
                  <input
                    type="tel"
                    name="phone"
                    required
                ...
                <div>
                  <label className="block text-[10px] uppercase tracking-wider mb-1">Shipping Address</label>
                  <textarea
                    name="address"
                    required
                    rows={3}
            ...
            <div className="bg-muted/30 p-8">
              <h2 className="text-[11px] uppercase tracking-[0.15em] mb-6 font-medium text-center">
                Order Summary
              </h2>
              ...
              <p className="text-[10px] text-muted-foreground mt-8 text-center leading-relaxed">
                By clicking "Complete Order", you will be redirected to our secure payment partner bog.com to finish your transaction.
              </p>
            </div>
          </div>
        </div>
